...
const PENDING_STATUS = "Pending Director Review";
...
export default function DirectorDashboard() {
  ...
  const pendingResolutionCount = resolutions.filter(
    (resolution) => resolution.status === PENDING_STATUS,
  ).length;
  const forwardedResolutionCount = resolutions.filter((resolution) =>
    ["Pending OVPSAS Approval", "Adopted"].includes(resolution.status),
  ).length;
    ...
    <div className="min-h-screen bg-[#FAFAFC] text-slate-800 font-sans flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="hidden sm:block truncate text-[11px] text-slate-500">
                  Review resolutions cleared by the dean before OVPSAS final
                  approval
                </p>
              </div>
            </div>
        ...
        <MobileTabBar
          ...
          items={navItems}
          label="Director portal navigation"
        />
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Monitor resolutions forwarded by the dean for your review
                  before OVPSAS final approval.
                </p>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-extrabold text-[#4A0E17]">
                      Director Approval Responsibility
                    </h3>
                    <p className="mt-1 text-xs leading-5 text-slate-600">
                      Only resolutions approved by the department dean appear
                      in your queue. Your approval records an e-signature and
                      forwards the resolution to OVPSAS for final approval.
                    </p>
                    <button
                      type="button"
